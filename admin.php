...
*/
			...
			function delete_account(){
				if(confirm("Do you really want to delete this admin Account?!")) {
					var x = new XMLHttpRequest();
					var url = "admin.php";
					var vars = 'deleteAdmin='+'<?php echo $_SESSION['id']; ?>';
					x.open("POST", url, true);
					x.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
					x.onreadystatechange = function() {
						if(x.readyState == 4 && x.status == 200) {
...
//truncating the tables and resetting the Exam
	 ...
	 //updating metadata for a quiz
		...
		function change_pass(){
			...
			document.getElementById('login').value = '<?php echo $_SESSION['id']; ?>';
...
<body style="font-family: Arial;">
  <div id="header" align="center">
       <img src="img/header.png" height="150" width="1340">
  </div>
...
<div id="admin_menu">   
	...
	<br>		
	<ul>
		<span id="Hello">Welcome, <a href="admin.php"><span id="usr"><?php echo $_SESSION['id']; ?>!</span></a></span>
			<a href="index.php" target="index.php">
				<li><img src="img/png/Home.png" width="13px" height="13px">&nbsp;&nbsp;Exam Page</li>	
			</a>

			<li><img src="img/ico/new document.ico" width="13px" height="13px">&nbsp;&nbsp;Examination Management
			  	<ul>
			  	...
			  	<li><img src="img/ico/modify.ico" width="13px" height="13px">&nbsp;&nbsp;Manage Questions
			  		<ul>
			  			<li>
			  		...
			  		<li><img src="img/png/3d bar chart.png" width="13px" height="13px">&nbsp;&nbsp;Report
			  			<ul>
			  		...
			  		<li><img src="img/png/Pinion.png" width="13px" height="13px">&nbsp;&nbsp;Settings
			    	<ul>
		    ...
		    <span style="color: red; font-size: 23px;" id="resetBtnMsg"></span>
		</div>
		...
		<div class="content" id="tf" style="margin-bottom: 100px;">
 		...
 		<div class="content" id="mc" style="margin-bottom: 100px;">
    		...
    		<form action="admin.php" name="addMcQuestion" method="POST">
    			...
    			<a href="admin.php">
    			<input type="button" class="add_to_quiz"  value="Close">
    			</a>
    		</form>
 		</div>
 		...
 		<div id="register" class="white_content">
			...
			<form action="addNewQuiz.php" class="newQuiz" method="POST" name="newQuiz_name" id="regNewQuiz">
				<p>
			      <label class="reg_label" for="quizName">Exam Name:</label><br>
			      <input type="text" name="quizName" id="quizName" required="required" autofocus>
			    </p>
			    <p>
			      <label class="reg_label" for="quizTime">Time Allotted per Minute:</label><br>
			      <input type="text" name="quizTime" id="quizTime" readonly value="60">
			    </p>
			    <p>
			      <label class="reg_label" for="numQues">Number of Items:</label><br>
